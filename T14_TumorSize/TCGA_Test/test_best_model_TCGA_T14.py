#Test best model on held-out TCGA set
...
from eval_metrics_multi_testset import get_metrics
...
au_roc_macro, pred_pos_dict, actual_pos_dict, f1_micro, class_specific_auroc_dict  = get_metrics(y_pred, y_true,
                                                                ...
                                                                suffix='test_best_model_TCGA', all_subtypes = True, plot=True)

print('AU-ROC:',au_roc_macro)