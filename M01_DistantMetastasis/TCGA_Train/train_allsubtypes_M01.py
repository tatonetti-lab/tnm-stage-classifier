#Fine-tune pre-trained model M01 TCGA 
...
lr_type = sys.argv[6] #new #'lower_lr' or 'default_lr'
if lr_type == 'lower_lr':
...
num_classes=len(set(input_data['label'])) 
...
def compute_metrics(eval_pred):
    ...
    roc = roc_auc_score(labels, score_pred[:,1])   
...
au_roc_macro, f1_micro = get_metrics(y_pred, y_val, output_dir=model_output_dir, seed = seed, 
