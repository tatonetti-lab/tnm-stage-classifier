...
def get_metrics(raw_pred, y_true, output_dir, seed, suffix='', all_subtypes=False, plot=True):
            ...
            for threshold_support in [3,5]: 
                ...
                for class_i in [1]: #class = 1
                    ...
                    for subtype in class_types:
                        ...
                        fpr[subtype], tpr[subtype], _ = roc_curve(subtype_bin, softmax_subtype) 
