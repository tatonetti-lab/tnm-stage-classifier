...
data_class_dict = {'n03X_data':{0:'N0', 1: 'N1', 2:'N2', 3:'N3'}}
...
def get_metrics(raw_pred, y_true, output_dir,  seed, test_csv, suffix='', all_subtypes=False, plot=True):
    ...
    if all_subtypes == True:
        ...
        if len(type_list) > 0: 
            ...
            plt.savefig(output_dir+'roc_curves_across_cancertypes_ALL_subtypes_NEW_'+suffix+'.png',dpi=900, facecolor='w') #new
            plt.close()
